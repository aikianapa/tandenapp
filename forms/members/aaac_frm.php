...
<div>
    ...
    <script> 
        var aaacFormsPrint = function() { 
            ...
            a.document.write('<link href="/engine/modules/cms/tpl/assets/css/dashforge.css" rel="stylesheet" type="text/css">'); 
                    ...
                    <div class="row my-2">
                        ...
                        <wb-foreach wb="count=9;1">
                            <div class="col-sm-4 my-1">
                                ...
                                <span>
                                <wb-foreach wb-from="_parent.exam" wb-filter="{'kudan': 'ku', 'level':'{{_value}}'}">
                    ...
                    <div class="row my-2">
                        <wb-foreach wb="count=1;6">
                            <div class="col-sm-4 my-1">
                                ...
                                <span>
                                <wb-foreach wb-from="_parent.exam" wb-filter="{'kudan': 'dan', 'level':'{{_value}}'}">
                                    <span>{{ dateout({{ ldate }}) }} </span>
                                </wb-foreach>
                                </span>
                            </div>
