...
<div class="chat-wrapper chat-wrapper-two">
    ...
    <nav class="nav navbar navbar-expand-md col">
      <a class="navbar-brand tx-bold tx-spacing--2 order-1" href="javascript:">Тикеты</a>
        ...
        <div class="list-group-item d-flex align-items-center">
            ...
            <div>
              <a href="javascript:" data-ajax="{'url':'/cms/ajax/form/{{_form}}/edit/{{_id}}','html':'.{{_form}}-edit-modal','modal':'#{{_form}}ModalEdit'}"
                ...
                <i class="ri-calendar-line"></i> {{start}} - {{stop}}
              </a>
              <a href="javascript:" data-ajax="{'url':'/cms/ajax/form/members/edit/{{member}}','html':'.{{_form}}-edit-modal','modal':'#membersModalEdit'}"
                class="tx-13 tx-inverse mg-b-0">
              <i class="ri-user-3-line"></i> {{show.member}}
              </a>
              <a href="javascript:" data-ajax="{'url':'/cms/ajax/form/finance/edit/{{payment}}','html':'.{{_form}}-edit-modal','modal':'#financeModalEdit'}"
              class="tx-13 tx-inverse mg-b-0">
                <i class="ri-coin-line"></i> {{payment}}
              </a>
